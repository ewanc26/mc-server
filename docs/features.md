...
* **Automatic Plugin Management:** Includes pre-configured plugins (TCPShield RealIP, ProtocolLib, PlayerHealthDisplay, ViaVersionStatus, ViaBackwards, ViaVersion, minefetch, and others via Spigot Resources).
